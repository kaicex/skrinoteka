...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "flex h-10 items-center justify-center rounded-lg bg-zinc-100 px-1 text-zinc-500 box-border",
      className
    )}
    {...props}
  />
