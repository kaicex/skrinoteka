...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={cn(
      "relative z-10 flex max-w-screen-xl px-6 mx-auto flex-1 items-center justify-center",
      className
    )}
    {...props}
  >
...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium text-zinc-400 transition-colors hover:bg-zinc-800 hover:text-zinc-50 focus:outline-none disabled:pointer-events-none disabled:opacity-50"
)
